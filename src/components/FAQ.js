...
function FAQ() {
  ...
  const subtitle = 'Find answers to common questions about Ayurveda, treatments, and our center';
  ...
  const faqItems = [
    {
      question: { en: "What is Ayurveda?", hi: "आयुर्वेद क्या है?", mr: "आयुर्वेद म्हणजे काय?" },
      answer: {
        en: "Indian traditional and integrative medicine is known as 'Ayurveda'. Ayurveda is translated as 'knowledge of life' from the Sanskrit words 'ayu' and 'veda,' which both mean 'life' and 'the knowledge,' respectively. This traditional medical practise has developed through the years, including centuries of knowledge that has been gained via intense meditation, intellectual and religious enlightenment, and practical experience. It demonstrates how, in the end, we can shape, lengthen, and govern our lives free from illness or ageing.",
        hi: "भारतीय पारंपरिक और समन्वित चिकित्सा प्रणाली को आयुर्वेद कहा जाता है। 'आयु' और 'वेद' से मिलकर बना आयुर्वेद जीवन के ज्ञान को दर्शाता है। यह प्राचीन प्रणाली ध्यान, अनुभव और ज्ञान पर आधारित है और दीर्घकालिक स्वास्थ्य पर बल देती है।",
        mr: "भारतीय पारंपरिक आणि समन्वित वैद्यकशास्त्राला आयुर्वेद म्हणतात. 'आयु' आणि 'वेद' या शब्दांपासून तयार झालेला आयुर्वेद म्हणजे जीवनाचे ज्ञान. ही प्रणाली अनुभव, साधना आणि तत्त्वज्ञानावर आधारित असून दीर्घकाळ निरोगी जीवनावर भर देते.",
      }
    },
    {
            ...
            >
              ...
              >
                <h3 className="font-medium text-lg pr-4">
                  {typeof item.question === 'string' ? item.question : L(item.question)}
                </h3>
