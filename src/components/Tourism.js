...
function Tourism() {
  const TXT = {
    discover: 'Discover Pune',
    subtitle: 'Explore the cultural capital of Maharashtra through its historic forts, vibrant markets, and natural wonders',
    oxford: '" The Oxford of the East "',
    intro: 'Pune seamlessly blends its rich Maratha heritage with modern urban energy. Founded in the 8th century, this city has been a center of education, culture, and history for centuries. From ancient cave temples to British-era architecture, Pune offers diverse experiences for every traveler.',
    mustVisit: 'Must-Visit Places',
    experiences: 'Pune Experiences',
    moreExplore: 'More to Explore',
    learnWiki: 'Learn more on Wikipedia',
  ...
  return (
    <div className="min-h-screen bg-amber-50 text-[17px]">
      ...
      <header className="py-10 text-center bg-green-900 text-amber-100">
        <h1 className="text-4xl font-serif font-bold">{TXT.discover}</h1>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12 text-center">
          <h2 className="text-3xl font-serif text-green-900 mb-4">{TXT.oxford}</h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-serif text-green-900 mb-6 text-center">{TXT.mustVisit}</h2>
        ...
        <section className="mb-16 bg-green-50 p-8 rounded-lg">
          <h2 className="text-3xl font-serif text-green-900 mb-8 text-center">{TXT.experiences}</h2>
        ...
        {/* More Attractions */}
        <section className="mb-16">
          <h2 className="text-3xl font-serif text-green-900 mb-6 text-center">{TXT.moreExplore}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <section className="bg-green-100 p-8 rounded-lg mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-serif text-green-900 mb-4">{TXT.bestTime}</h3>
            ...
            <div>
              <h3 className="text-2xl font-serif text-green-900 mb-4">{TXT.gettingAround}</h3>
              <p className="text-amber-800 mb-4">
