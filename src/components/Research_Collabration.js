          ...
          <div className="p-6 md:p-8">
            <div className="prose max-w-none">
              ...
              <div className="mb-8 bg-[#f8f5f0] p-5 rounded-lg border-l-4 border-[#d4a017]">
                <h2 className="text-xl font-bold text-[#0a5f38] mb-3">Basic Research</h2>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-bold text-[#0a5f38] mb-3">Publication</h2>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-bold text-[#0a5f38] mb-3">Completed Projects</h2>
