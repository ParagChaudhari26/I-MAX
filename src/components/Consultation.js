...
function Consultation(){
    ...
    const TXT = {
      heading: { en: 'CONSULTATION', hi: 'परामर्श', mr: 'सल्लामसलत' },
      mainTitle: { en: 'Comprehensive Ayurvedic Consultations', hi: 'समग्र आयुर्वेदिक परामर्श', mr: 'समग्र आयुर्वेदिक सल्लामसलत' },
      subTitle: { en: 'Discover your unique constitution and receive personalized health guidance', hi: 'अपनी अनूठी प्रकृति जानें और व्यक्तिगत स्वास्थ्य मार्गदर्शन पाएं', mr: 'तुमची प्रकृती ओळखा आणि वैयक्तिक आरोग्य मार्गदर्शन मिळवा' },
      services: { en: 'Our Ayurveda Consultation Services', hi: 'हमारी आयुर्वेद परामर्श सेवाएँ', mr: 'आमच्या आयुर्वेद सल्ला सेवा' },
      approach: { en: 'The Ayurvedic Approach to Health', hi: 'स्वास्थ्य के लिए आयुर्वेदिक दृष्टिकोण', mr: 'आरोग्याकडे आयुर्वेदिक दृष्टिकोन' },
      bodyType: { en: 'Understanding Your Body Type (Prakriti)', hi: 'अपनी प्रकृति (प्रकृति) को समझें', mr: 'तुमची प्रकृती समजून घ्या' },
      options: { en: 'Consultation Options', hi: 'परामर्श विकल्प', mr: 'सल्ला पर्याय' },
      prevention: { en: 'Ayurveda Consultation for Prevention and Cure', hi: 'रोकथाम और उपचार हेतु आयुर्वेद परामर्श', mr: 'प्रतिबंध आणि उपचारासाठी आयुर्वेद सल्ला' },
    };
...
The fundamental wisdom is very basic and deals with simple facts of life. It teaches us to keep our body and mind in tune with rest of the cosmos. If we follow this tradition, we will be able to live happily, we can be more productive at work and we can give and share as members of a creative society.
            ...
            <div className="mb-16  rounded-xl p-8 text-[17px]">
              <div className="flex flex-wrap items-center gap-8 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-emerald-900 mb-4">{L(TXT.bodyType)}</h3>
            ...
            <div className="mb-16 text-[17px]">
              <div className="bg-white p-8">
                <h3 className="text-2xl font-bold text-emerald-900 mb-6">{L(TXT.options)}</h3>
